...
if __name__ == "__main__":
    ...
    Ns = [52360, 74048, 104720]
    # Ns = [148096, 209440, 296193, 418880, 592368, 1184736]
    # Ns = [296193]
    # Ns = [74048, 148096]
    # Ns = [654]
    num_trials = 108
    ...
    for N in Ns:
        ...
        print(f"Finished writing CSV (using inline={inline}) for N={N} with {num_workers} workers.")
...
# to copy whole folder from biggee to Desktop
    ...
    # rsync -avz sibrahim@biggee.phy.olemiss.edu:/localhome/sibrahim/Desktop/GitRepos/cst_longest_maximal_chains/DAGs/LMCs_data/Intervals/ ./LMCs_data/Intervals_from_hpc/
