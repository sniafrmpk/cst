...
def causet_tau_c_files(folder_path, R_sparse, i, j):
    ...
    R_k = identity(N, format='csr') # I should remove this step by putting a k=1 condition below and saving R_1 directly.
...
def LMCs_files(N = 10000):
    ...
    k_max, numofmaxchains = causet_tau_c_files(folder_path, R, i, j)
    ...
    return fc, numofmaxchains, R, all_levels
